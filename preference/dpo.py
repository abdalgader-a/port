...
if __name__ == "__main__":
    parser = TrlParser((DPOScriptArguments, DPOConfig, ModelConfig, ExtractorScriptArguments))
    args, training_args, model_config, extractor_args = parser.parse_args_and_config()
    ...
    train_data = Dataset.from_pandas(
        data_extractor(tokenizer, scheme=extractor_args.scheme, model=extractor_args.llm, split=args.dataset_train_split, dataset=extractor_args.dataset),
